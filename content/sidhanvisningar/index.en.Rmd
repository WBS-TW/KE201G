...
Nedan finns **en del** av den litteratur som ingår i kursen. Det rekommenderas att läsa på dessa avsnitt innan relaterade kursmoment startar. Boken General Chemistry (11th ed) är endast rekommenderad läsning (alltså inte obligatorisk litteratur). Repetition av kemi samt kemiska beräkningar hittar ni i översta menun, vilket rekommenderas starkt för alla.
