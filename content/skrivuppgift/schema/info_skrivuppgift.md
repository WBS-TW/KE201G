...
o	har Harvard eller Vancouver använts?
o	är formatet av källhänvisning i text och i bibliografin korrekt och konsekvent?
o	är antal referenser lämpligt med tanke på textinnehållet?
o	är placering på referensen i text lämpligt, finns det text som saknar referens?
•	Allmänt språkbruk och meningsbyggnad
o	förstår man texten, har fullständiga meningar använts, konsekvent tempus, etc.
